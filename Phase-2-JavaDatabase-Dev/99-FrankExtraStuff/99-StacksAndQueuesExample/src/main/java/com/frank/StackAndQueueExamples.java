 ...
 **********************************************************************************/
		...
		// Note: A Queue may be implemented using a LinkedList
		
		LinkedList <String> myQueue = new LinkedList<String>();	    
		
		myQueue.add("Serafino");
		myQueue.add("Frank");
		myQueue.push("Fortunato");   // Put at the start of Queue
		
		myQueue.add("Mary");
		myQueue.add("Rosario");
		myQueue.add("Frank");		// Duplicates are allowed	
