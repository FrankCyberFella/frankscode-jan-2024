...
public class ApplicationProgram {
		...
		public static void main(String[] args) {
			...
			Map<String, String> starshipCaptains = new HashMap(); // a HashMap stores the entries in an unknown entry sequence
			...
			starshipCaptains.remove("Odyssey"); // remove the entry for the "" from the Map
