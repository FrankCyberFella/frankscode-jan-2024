...
public class TestCardApp {
	...
	public static void main(String[] args) {
    	 ...
    	 * 
    	 * To instantiate an object of a class: new constructorName(parameters)
    	 ************************************************************************************/
    	...
    	// Note use of PlayingCard enums to specify the value and suit
    	...
    	// Note: use of int and PlayingCard suit enum
    	PlayingCard someCard = new PlayingCard(2, PlayingCard.CardSuit.HEART);
    	System.out.print("someCard: \t" + someCard);
    	
    	// .setSuit(CardSuit) is allowed to be used by this program because its public in the class
    	aCard.setSuit(PlayingCard.CardSuit.CLUB); 
    	System.out.print("\n\naCard: \t" + aCard);
     	  
    	//aCard.setColor(PlayingCard.CardColor.RED);  // error because setColor() is private
		...
		// Loop while there are cards in the cardDeck - note use of CardDeck method to ask if any cards in deck
		while (myDeck.anyCardsInDeck()) {
			System.out.println(myDeck.dealCard().toString()); // deal a card and display as a String (using toString)
		//  System.out.println(myDeck.dealCard()); // OK too - wanted to demo use of specific call to toString()	
		}
		...
		/*************************************************************************************
    	 * Demonstrate use of PlayingCard and CardDeck  class to deal a hand of 5 cards
    	 ************************************************************************************/
