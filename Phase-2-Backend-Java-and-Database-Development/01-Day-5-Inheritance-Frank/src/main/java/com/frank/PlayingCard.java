 ...
 * Nothing indicates this is a super class
 ***************************************************************************************/
public class PlayingCard {
	...
	public boolean equals(Object obj) {    // Note: Parameter is a generic Object class because this is an override
		...
		// this is the object to left of the . when the method is invoked
		//
		//    myCard.equals(yourCard);   this represents myCard and obj (parameter) represents yourCard
		...
		PlayingCard other = (PlayingCard) obj; // Instantiate a PlayingCard from the object passed as parameter
	...
	/***************************************************************************************
	 * .clone() method is used to make a "deep copy" of an object
	 * 
	 * a "deep copy" is a new object with the data copied into it from the source object.
	 * 
	 * a "shallow copy" coping the reference to object not the data
	 * 
	 * PlayingCard aCard = myCard;            // "shallow copy" - aCard and myCard reference the object
	 * 
	 * PlayingCard yourCard = myCard.clone(); // "deep copy" - yourCard is a new object with the data in myCard 
	 * 
